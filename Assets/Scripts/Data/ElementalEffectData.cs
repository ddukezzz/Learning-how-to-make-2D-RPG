...
public class ElementalEffectData
{
    ...
    public ElementalEffectData(Entity_Stats entityStats, DamageScaleData damageScale)
    {
        ...
        totalBurnDamage = entityStats.offense.fireDmg.GetValue() * damageScale.burnDamageScale;
        
        shockDuration = damageScale.shockDuration;
        shockDamage = entityStats.offense.lightningDmg.GetValue() * damageScale.shockDamageScale;
