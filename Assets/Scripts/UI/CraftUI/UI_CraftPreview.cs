...
public class UI_CraftPreview : MonoBehaviour
{
    ...
    public void SetupCraftPreview(Inventory_Storage storage)
    {
        ...
        foreach(var slot in craftPreviewSlots) slot.gameObject.SetActive(false);
    }
    ...
    public void ConfirmCraft()
    {
        ...
        if (storage.CanCraftItem(itemToCraft)) storage.CraftItem(itemToCraft);
